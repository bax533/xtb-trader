...
eurusd_lines_M = {
    ("M30", smallest_period) : MA_Line(SYMBOL, "M30", smallest_period),
    ("M30", middle_period) : MA_Line(SYMBOL, "M30", middle_period),
    ("M30", biggest_period) : MA_Line(SYMBOL, "M30", biggest_period)
}
